...
/*
 * Beam Lib Card — surface wrapped with the published `border-beam` package.
 * Visually identical to beam-custom's card; the only difference is who
 * draws the rainbow stroke (the npm package vs. our hand-rolled CSS).
 */
