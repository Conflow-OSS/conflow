...
const navigationMenuTriggerStyle = cva(
  "inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium " +
    ...
    "data-[active]:bg-accent/60 data-[state=open]:bg-accent"
)
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-popover border-t border-l border-border" />
  </NavigationMenuPrimitive.Indicator>
))
