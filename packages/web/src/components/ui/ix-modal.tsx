      ...
      {open ? (
        ...
        >
          ...
          <motion.div
            ...
            className={`relative flex w-full flex-col overflow-hidden rounded-xl border border-border bg-card text-card-foreground shadow-lg outline-none ${className}`}
          >
            <div className="flex shrink-0 items-start gap-3 px-4 pb-3 pt-4">
              ...
              {showClose ? (
                <button
                  ...
                  className="-mr-1 -mt-1 grid size-7 shrink-0 place-items-center rounded-md text-muted-foreground/70 outline-none transition-colors duration-150 hover:bg-muted hover:text-foreground focus-visible:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-0"
                >
                  {CLOSE_ICON}
                </button>
              ) : null}
