...
==============================================
Reminder, every time: match the CANONICAL VOICE EXAMPLES below in voice, vibe, and style.
No em-dashes (—) anywhere in the post; use a comma, a semicolon, or (parentheses) instead.
...
• No em-dashes (—) anywhere, in any post. Use a comma, a semicolon, or (parentheses) for a
  pause or an aside instead. No "essay rhythm" of dash-asides, because there are no dashes.
